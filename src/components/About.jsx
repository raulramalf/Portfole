...
export default function About() {
  return (
    <section id="sobre-mi" className="px-6 md:px-16 py-24 bg-slate">
      <Reveal>
      ...
      <Reveal delay={200}>
        <p className="text-muted max-w-2xl leading-relaxed">
          Prefiero comprender en profundidad una tecnologia antes de incorporarla
          a un proyecto, priorizando la solidez tecnica frente a la adopcion
          apresurada de nuevas herramientas. En los ultimos meses he dedicado
          tiempo a la automatizacion de procesos y a la integracion de
          inteligencia artificial en flujos de desarrollo, buscando reducir
          tareas repetitivas y aportar valor real a los equipos de trabajo.
        </p>
      </Reveal>
    </section>
  );
